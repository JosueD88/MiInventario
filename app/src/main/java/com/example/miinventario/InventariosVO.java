...
public class InventariosVO {
    ...
    public InventariosVO(String nombre, int cantidad_integrantes, String rol, String fecha_creacion) {
        this.nombre = nombre;
    ...
    public int getCantidad_integrantes() { return cantidad_integrantes; }

    public void setCantidad_integrantes(int cantidad_integrantes) { this.cantidad_integrantes = cantidad_integrantes; }
